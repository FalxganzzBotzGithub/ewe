...
async function startXeonBotInc() {
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['KONTOL BOT INI GEDELOH','Safari','1.0.0'],
        auth: state
    })
    ...
    XeonBotInc.sendMessage(callerId, { text: `*Otomatis Block Sistem*\n*Jangan Telpon Bot*!\n*Jika Blokiran Ini Ingin Dibuka Harus Chat Admin Botz Ini Nomor 089526713930 !*`}, { quoted : halal })
    await sleep(8000)
